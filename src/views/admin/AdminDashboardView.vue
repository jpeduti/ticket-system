    ...
    <main class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
      ...
      <div class="px-4 py-6 sm:px-0">
        <div class="border-4 border-dashed border-gray-200 rounded-lg p-8">
          ...
          <p class="text-gray-600">Panel de control del sistema de tickets</p>
        </div>
      </div>
...
import { Ticket as TicketIcon, CheckCircle, Clock, AlertCircle } from 'lucide-vue-next'
...
const loadCategoryStats = async () => {
  try {
    categoryStats.value = await ticketsStore.getTicketStatsByCategory()
  } catch (error) {
